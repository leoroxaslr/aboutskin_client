                      ...
                      <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                        ...
                        <div className="mt-6">
                          {numberOfItemsInCart > 0 ? (
                            <button className="btn btn-wide mx-auto flex items-center justify-center rounded-md border border-transparent btn-neutral px-6 py-3 text-base font-light text-white shadow-sm hover:btn-primary">
                              Checkout
                            </button>
                          ) : (
                            <button
